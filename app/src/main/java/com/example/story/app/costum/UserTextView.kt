...
class UserTextView : AppCompatEditText {
    ...
    private fun init() {
        userIconDrawable = ContextCompat.getDrawable(context, R.drawable.icon_person)!!
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                // Validasi user
                // Tampilkan pesan kesalahan secara otomatis jika nama pengguna tidak memenuhi kriteria tertentu
